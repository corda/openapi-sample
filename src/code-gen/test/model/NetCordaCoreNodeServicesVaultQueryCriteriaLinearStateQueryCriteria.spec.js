...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiJsClient.NetCordaCoreNodeServicesVaultQueryCriteriaLinearStateQueryCriteria();
  });
  ...
  describe('NetCordaCoreNodeServicesVaultQueryCriteriaLinearStateQueryCriteria', function() {
    it('should create an instance of NetCordaCoreNodeServicesVaultQueryCriteriaLinearStateQueryCriteria', function() {
      // uncomment below and update the code to test NetCordaCoreNodeServicesVaultQueryCriteriaLinearStateQueryCriteria
      //var instane = new OpenapiJsClient.NetCordaCoreNodeServicesVaultQueryCriteriaLinearStateQueryCriteria();
      //expect(instance).to.be.a(OpenapiJsClient.NetCordaCoreNodeServicesVaultQueryCriteriaLinearStateQueryCriteria);
    });
