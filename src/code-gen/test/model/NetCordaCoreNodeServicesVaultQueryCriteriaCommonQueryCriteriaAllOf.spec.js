...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiJsClient.NetCordaCoreNodeServicesVaultQueryCriteriaCommonQueryCriteriaAllOf();
  });
  ...
  describe('NetCordaCoreNodeServicesVaultQueryCriteriaCommonQueryCriteriaAllOf', function() {
    it('should create an instance of NetCordaCoreNodeServicesVaultQueryCriteriaCommonQueryCriteriaAllOf', function() {
      // uncomment below and update the code to test NetCordaCoreNodeServicesVaultQueryCriteriaCommonQueryCriteriaAllOf
      //var instane = new OpenapiJsClient.NetCordaCoreNodeServicesVaultQueryCriteriaCommonQueryCriteriaAllOf();
      //expect(instance).to.be.a(OpenapiJsClient.NetCordaCoreNodeServicesVaultQueryCriteriaCommonQueryCriteriaAllOf);
    });
