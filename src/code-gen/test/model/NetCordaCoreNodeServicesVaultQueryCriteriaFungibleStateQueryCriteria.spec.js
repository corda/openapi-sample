...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiJsClient.NetCordaCoreNodeServicesVaultQueryCriteriaFungibleStateQueryCriteria();
  });
  ...
  describe('NetCordaCoreNodeServicesVaultQueryCriteriaFungibleStateQueryCriteria', function() {
    it('should create an instance of NetCordaCoreNodeServicesVaultQueryCriteriaFungibleStateQueryCriteria', function() {
      // uncomment below and update the code to test NetCordaCoreNodeServicesVaultQueryCriteriaFungibleStateQueryCriteria
      //var instane = new OpenapiJsClient.NetCordaCoreNodeServicesVaultQueryCriteriaFungibleStateQueryCriteria();
      //expect(instance).to.be.a(OpenapiJsClient.NetCordaCoreNodeServicesVaultQueryCriteriaFungibleStateQueryCriteria);
    });
