...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiJsClient.NetCordaCoreNodeServicesVaultQueryCriteriaFungibleAssetQueryCriteriaAllOf();
  });
  ...
  describe('NetCordaCoreNodeServicesVaultQueryCriteriaFungibleAssetQueryCriteriaAllOf', function() {
    it('should create an instance of NetCordaCoreNodeServicesVaultQueryCriteriaFungibleAssetQueryCriteriaAllOf', function() {
      // uncomment below and update the code to test NetCordaCoreNodeServicesVaultQueryCriteriaFungibleAssetQueryCriteriaAllOf
      //var instane = new OpenapiJsClient.NetCordaCoreNodeServicesVaultQueryCriteriaFungibleAssetQueryCriteriaAllOf();
      //expect(instance).to.be.a(OpenapiJsClient.NetCordaCoreNodeServicesVaultQueryCriteriaFungibleAssetQueryCriteriaAllOf);
    });
