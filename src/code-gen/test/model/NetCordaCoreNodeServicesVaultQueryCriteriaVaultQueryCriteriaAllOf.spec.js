...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiJsClient.NetCordaCoreNodeServicesVaultQueryCriteriaVaultQueryCriteriaAllOf();
  });
  ...
  describe('NetCordaCoreNodeServicesVaultQueryCriteriaVaultQueryCriteriaAllOf', function() {
    it('should create an instance of NetCordaCoreNodeServicesVaultQueryCriteriaVaultQueryCriteriaAllOf', function() {
      // uncomment below and update the code to test NetCordaCoreNodeServicesVaultQueryCriteriaVaultQueryCriteriaAllOf
      //var instane = new OpenapiJsClient.NetCordaCoreNodeServicesVaultQueryCriteriaVaultQueryCriteriaAllOf();
      //expect(instance).to.be.a(OpenapiJsClient.NetCordaCoreNodeServicesVaultQueryCriteriaVaultQueryCriteriaAllOf);
    });
