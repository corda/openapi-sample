...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenapiJsClient.NetCordaCoreNodeServicesVaultQueryCriteriaVaultCustomQueryCriteriaAllOf();
  });
  ...
  describe('NetCordaCoreNodeServicesVaultQueryCriteriaVaultCustomQueryCriteriaAllOf', function() {
    it('should create an instance of NetCordaCoreNodeServicesVaultQueryCriteriaVaultCustomQueryCriteriaAllOf', function() {
      // uncomment below and update the code to test NetCordaCoreNodeServicesVaultQueryCriteriaVaultCustomQueryCriteriaAllOf
      //var instane = new OpenapiJsClient.NetCordaCoreNodeServicesVaultQueryCriteriaVaultCustomQueryCriteriaAllOf();
      //expect(instance).to.be.a(OpenapiJsClient.NetCordaCoreNodeServicesVaultQueryCriteriaVaultCustomQueryCriteriaAllOf);
    });
